...
以下のJSONフォーマット（配列形式）で, 合計8件のレシピを提案してください。
...
提案の条件：
1. **【最重要】提案する8件のうち、必ず2件は「【おすすめセット】（主菜・副菜・スープ等の汁物を組み合わせた1食丸ごとのMeal・セットメニュー）」として提案してください。**
...
2. 残りの6件は、従来どおりの単品おかずとして提案してください。
3. 全体の中で、4件程度は「今ある材料で作れるもの」、残り4件程度は「あと1つだけ特定の食材を買い足せば作れるもの（要買い足し）」のバランスにしてください（おすすめセットがどちらに該当しても構いません）。
